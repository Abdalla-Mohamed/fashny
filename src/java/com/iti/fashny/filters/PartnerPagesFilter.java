 ...
 * @author Abdalla
 */
@WebFilter(filterName = "PartnerPagesFilter", urlPatterns = {"/faces/companypages/*"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.ERROR, DispatcherType.INCLUDE})
